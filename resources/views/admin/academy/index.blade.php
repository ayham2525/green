            ...
            <div class="col">
                <div class="row align-items-center">
                    <div class="col col-lg-11">
                        <h5 class="fs-0 mb-10 mb-sm-0 text-primary">Academy List</h5>
                    </div>
            ...
            <div class="col-lg-12">
                ...
                <table class="table mb-0 data-table fs--1">
                    ...
                    <tbody>
                        ...
                        @foreach ($academys as $x)
                            <tr>
                                <td class="align-middle subject py-2 pe-4 fw-semi-bold">{{ $x->id }}</td>



                                <td class="align-middle subject py-2 pe-4 fw-semi-bold">{{ $x->branche->branch_name }}
                                </td>


                                <td class="align-middle subject py-2 pe-4 fw-semi-bold">{{ $x->academy_name }}</td>



                                <td>
                                    <form action="{{ route('academy.destroy', $x->id) }}" method="POST">

                                        <button class="btn btn-falcon-primary me-1 mb-1" type="button"
                                            data-bs-toggle="modal"
                                            data-bs-target="#aca{{ $x->id }}">Edit</button>
                            ...
                            <div class="modal fade" id="aca{{ $x->id }}" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-content border-0">
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="bg-light rounded-top-lg py-3 ps-4 pe-6">
                                                <h4 class="mb-1" id="staticBackdropLabel">Edit Academy</h4>
                                            </div>
                                            <div class="p-4">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <form action="{{ route('academy.update', $x->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('PUT')
                                                                ...
                                                                <div class="col-xs-12 col-sm-12 col-md-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="academy_name"
                                                                            class="form-control"
                                                                            placeholder="{{ $x->academy_name }}"
                                                                            value="{{ $x->academy_name }}">
                                                                    </div>
                                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="branch_id" class="form-select">
                                                @foreach ($branch as $y)
                                                    <option value="{{ $y->id }}">{{ $y->branch_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
